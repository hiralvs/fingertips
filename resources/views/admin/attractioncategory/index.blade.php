        ...
        <div class="col-sm-6">
			<div class="d-flex align-items-center justify-content-md-end">
                <div class="pr-1 mb-3 mb-xl-0">
                    <a id="addnew15" class="btn btn-primary" data-toggle="modal" data-target="#addCategory" tabindex="" style="">
                        ADD NEW
                    </a>
                </div>               
            </div>
                    ...
                    <table class="table table-hover" id="categorytableData">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <a class="delete" onclick="return confirm('Are you sure you want to delete this Attraction Category?')" href="{{route('attractioncategory.delete', $value->id)}}"><i class="mdi mdi-delete"></i></a> </td>
                        </tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group col-xs-12">
                                                    <input type="text"  value="{{ $value->cat_image != null ? $value->cat_image : ''}}" class="form-control cat_image" disabled placeholder="Upload Image">
...
$(document).ready(function(){
    ...
    $(document).on('click','.editCategorySubmit',function(e){
        ...
        var formData = new FormData($("#editcategoryform"+id)[0]);
            ...
            $.ajax({
                url: "{{ route('attractioncategory.update') }}",
                method: 'post',
                cache: false,
                contentType: false,
                processData: false,
         ...
         $( '#cat_image-error').html( "" );    
            ...
            $.ajax({
                ...
                if(result.status == true)
                {
                    ...
                    var deleteurl = '{{ route("attractioncategory.delete", ":id") }}';
            ...
            <p class="statusMsg"></p>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="file" name="cat_image" class="file-upload-default">
                        <div class="input-group col-xs-12">
                            <input type="text" class="form-control file-upload-info" id="cat_image" disabled placeholder="Upload Image">
                            <span class="input-group-append">
                                <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                            </span>
                        </div>
