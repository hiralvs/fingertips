<div class="row mt-4">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
            <h4 class="card-title" style="float:left">{{$title}}-Property Admin</h4>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="property_admintableData">
                <thead>
                    <tr>
                    <th>Image</th>
                ...
                <tbody>
                    @if(!empty($propertyadmindata) && $propertyadmindata->count() > 0)
                        @foreach($propertyadmindata as $key => $value)
                    <tr>
                    <td>
                ...
                <div id="property_adminpaging">
                {{ $propertyadmindata->appends(['role' => 'property_admin'])->links() }}
                </div>
            </div>
        </div>
    </div>
