<div class="row mt-4">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
            <h4 class="card-title" style="float:left">{{$title}}-Customer</h4>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="customertableData">
                <thead>
                    <tr>
                    <th>Image</th>
                ...
                <tbody>
                    @if(!empty($customerdata) && $customerdata->count() > 0)
                ...
                {{ $customerdata->appends(['role' => 'customer'])->links() }}
                </div>
            </div>
        </div>
    </div>
