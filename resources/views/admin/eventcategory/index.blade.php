                    ...
                    <table class="table table-hover" id="categorytableData">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <a class="delete" onclick="return confirm('Are you sure you want to delete this Event Category?')" href="{{route('eventcategory.delete', $value->id)}}"><i class="mdi mdi-delete"></i></a> </td>
                        </tr>
...
$(document).ready(function(){
    ...
    $(document).on('click','.editCategorySubmit',function(e){
        ...
        var formData = new FormData($("#editcategoryform"+id)[0]);
            ...
            $.ajax({
                url: "{{ route('eventcategory.update') }}",
                method: 'post',
                cache: false,
                contentType: false,
                processData: false,
         ...
         $( '#cat_image-error').html( "" );    
            ...
            $.ajax({
                ...
                if(result.status == true)
                {
                    ...
                    var deleteurl = '{{ route("eventcategory.delete", ":id") }}';
