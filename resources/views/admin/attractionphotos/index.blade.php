                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="edit open_modal" data-toggle="modal" data-id="{{$value->id}}" data-target="#editPhotos{{$value->id}}" ><i class="mdi mdi-table-edit"></i></a>
                                <a class="delete" onclick="return confirm('Are you sure you want to delete this Photos?')" href="{{route('attractionphotos.delete', $value->id)}}"><i class="mdi mdi-delete"></i></a> </td>
                        </tr>
...
$(document).ready(function(){
    ...
    $(document).on('click','.editPhotosSubmit',function(e){
        ...
        var id = $(this).data('id');
            ...
            $.ajax({
                url: "{{ route('attractionphotos.update') }}",
                method: 'post',
                cache: false,
                contentType: false,
                processData: false,
