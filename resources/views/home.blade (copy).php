       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-8 content-top-2">
				...
				<!--graph-->
		<link rel="stylesheet" href="{{asset('/public/css/graph.css')}}">
		<!--//graph-->
		...
		<div class="content-mid">
			...
			<div class="col-md-5">
			  ...
			  <!----Calender -------->
			<link rel="stylesheet" href="{{asset('/public/css/clndr.css')}}" type="text/css" />
				...
				<div class="post">
					...
					<div class="post-at">
						<ul class="icon">
							...
							<input id="input-1" name="input1[]" type="file" multiple="" class="file">
							</div>
							<div  class="post-file">
							<i class="fa fa-camera"></i>
							<input id="input-2" name="input2[]" type="file" multiple="" class="file">
							</div>
							<div  class="post-file">
							<i class="fa fa-video-camera"></i>
							<input id="input-3" name="input3[]" type="file" multiple="" class="file">
							</div>
							<div  class="post-file">
							<i class="fa fa-microphone"></i>
							<input id="input-4" name="input4[]" type="file" multiple="" class="file">
							</div>
